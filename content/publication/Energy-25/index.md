---
title: 'Autoregressive model-based parameter correlation for state of charge and state of health of lithium-ion batteries using built-in piezoelectric transducer induced ultrasonic waves'
...
url_pdf: 'publication/energy-25/paper19.pdf'
